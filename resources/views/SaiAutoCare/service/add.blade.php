  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row" id="modelDivHide" >
        <div class="col-sm-2 text-primary" id="brandShow" align="center"><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-1x " aria-hidden="true" ></i></button>Add Brand</div>
        <div class="col-sm-2 text-success" id="modelShow" align="center"><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-1x " aria-hidden="true" ></i></button>Add Model</div>       
        ...
        <div class="col-sm-2 text-primary" id="serviceShow" align="center"><button class="btn btn-primary btn-sm"><i class="fa fa-plus-circle fa-1x " aria-hidden="true" ></i></button>Add Service</div>
        <div class="col-sm-2 text-primary" id="HideAll" align="center"><button class="btn btn-danger btn-sm"><i class="fa fa-minus-circle fa-1x " aria-hidden="true" ></i></button></div>
      </div>
