                ...
                <table style="font-size: 13px;display:table-cell;" class="table  table-hover " >
                  ...
                  <tbody>
                   ...
                   <a href="{{ url('/')}}/master/brands/update/{{ $value['id'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                      <a style="display: none" href="{{ url('/')}}/master/brands/trash/{{ $value['id']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a>
                  </td>
                    </tr>
