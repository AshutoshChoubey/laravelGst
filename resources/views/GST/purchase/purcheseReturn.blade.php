...
<section class="content" style="margin-left: 20px;margin-right: 20px;">
  <div class="row" style="display: none">
      <div class="col-sm-12" class="text-center">
         {{ Form::open(['url' => 'GST/sales/search','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }} 
    ...
    <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            <i class="fa fa-align-justify"></i> Purchase Return Details
          </div>
          <div class="card-body table-responsive" style="font-size: 13px;padding-left:10px;vertical-align:middle;">
            <table  id="example"  class="table   table-hover  " style="font-size: 13px;display:table-cell;" >
              <thead class="thead-dark">
                <tr>
                  <th style="white-space: nowrap">Purchase Return Id</th>
                  <th style="white-space: nowrap"><small>Purchase Invoice Id</small></th>
                  <th style="white-space: nowrap"><small>Purchase  Id</small></th>
                 ...
                 {{--  <th style="white-space: nowrap">Sale Invoice Number</th>
                  ...
                  <th style="white-space: nowrap">Returned quantity</th>
              ...
              <tbody>
                @foreach($purcheseReturn as $key => $value)
                <tr>
                  <td>{{ $value['id'] }}</td>
